...
import { Segment, Message, Icon, Input, Accordion } from 'semantic-ui-react';
    ...
    if (!this.isValidURL(proxyUrl)) {
      ...
      axios
        ...
        .then(res => {
          ...
          const localState = { ...this.props, proxyUrl };
        ...
        <Segment basic attached>
          ...
          {this.state.proxyUrl === '' && (
            <div style={{ paddingTop: '1em' }}>
              ...
              <p>
                Check out the installation guide bellow.
                <br /> Once you have your data compression service running
                &mdash; put its URL into the field above.
              </p>
            </div>
          )}
          ...
          <Accordion fluid styled>
            ...
            <Accordion.Content>
              <p>
                Heroku is a cloud-based app hosting provider.
                <br />
